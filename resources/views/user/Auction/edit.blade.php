    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="code" placeholder="Enter Code"  value='{{$post->code}}'class="form-control" readonly>
          @error('code')
       ...
       <div class="form-group">
          ...
          <select name="category_id" class="form-control">
              ...
              {{-- <option value='{{$categories->title}}'>{{$data->title}}</option> --}}
          @endforeach
              @endif
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="description" name="description" value={!! html_entity_decode( $post->description)!!}> </textarea>
          @error('description')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="date" name="startDate" class="form-control" value='{{$post->startDate}}'>
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="date" name="endDate" class="form-control"value='{{$post->endDate}}'>
          @error('endDate')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        <div class="form-group">
          ...
          <input id="inputTitle" type="number" name="min_price" class="form-control" value='{{$post->min_price}}'>
          @error('min_price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <select name="type" class="form-control">
              <option value="{{$post->type}}">Free</option>
        ...
        <div class="form-group">
          ...
          <select name="purpose" class="form-control">
              <option value="{{$post->purpose}}">Sale</option>
              <option value="{{$post->purpose}}">Buy</option>
          </select>
          @error('type')
          <span class="text-danger">{{$message}}</span>
          @enderror
        ...
        <div class="form-group">
            <label for="inputTitle" class="col-form-label">Collateral Percent<span class="text-danger">*</span></label>
            <input id="inputTitle" type="number" name="collateral_percent" value='{{$post->collateral_percent}}' class="form-control">
            @error('collateral_percent')
            <span class="text-danger">{{$message}}</span>
            @enderror
          </div>
