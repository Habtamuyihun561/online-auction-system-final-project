            ...
            //   $parent_cats=DB::table('post_categories')->select('title')->where('id',$category->parent_id)->get();
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        <a href="{{route('postcategory.edit',$category->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
