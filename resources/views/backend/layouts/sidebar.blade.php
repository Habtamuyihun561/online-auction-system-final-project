<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item">
        ...
        <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('postcategory.index')}}">Category</a>
            <a class="collapse-item" href="{{route('postcategory.create')}}">Add Category</a>
          </div>
        </div>
      </li>
    <!-- generate report -->
    <li class="nav-item">
        <a class="nav-link" href="{{route('winnerusers')}}">
          <i class="fas fa-fw fa-folder"></i>
          <span>Select Winner</span></a>
      </li>
    <li class="nav-item">
    ...
    <!-- View Winner -->
    <li class="nav-item">
      <a class="nav-link" href="{{route('auctionwinnerlist')}}">
        <i class="fas fa-fw fa-folder"></i>
